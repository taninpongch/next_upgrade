...
describe('MonetaryValue to Amount', () => {
  ...
  TestMonetaryValuetoAmount(5305, 5.305);
  TestMonetaryValuetoAmount(5309, 5.309);
  TestMonetaryValuetoAmount(5315, 5.315);
  TestMonetaryValuetoAmount(5319, 5.319);
  TestMonetaryValuetoAmount(5399, 5.399);
});
...
describe('MonetaryValue to Text', () => {
  ...
  TestMonetaryValuetoText(5305, "THB", "all", "5.30 THB");
  TestMonetaryValuetoText(5309, "THB", "all", "5.30 THB");
  TestMonetaryValuetoText(5315, "THB", "all", "5.31 THB");
  TestMonetaryValuetoText(5319, "THB", "all", "5.31 THB");
  TestMonetaryValuetoText(5399, "THB", "all", "5.39 THB");
  TestMonetaryValuetoText(1001, "THB", "all", "1.00 THB");
  TestMonetaryValuetoText(999, "THB", "all", "0.99 THB");
  TestMonetaryValuetoText(9995, "THB", "all", "9.99 THB");
  TestMonetaryValuetoText(10005, "THB", "all", "10.00 THB");
  TestMonetaryValuetoText(123456, "THB", "all", "123.45 THB");
  TestMonetaryValuetoText(8500, "THB", "all", "8.50 THB");   // 8.5 → 8.50
  TestMonetaryValuetoText(18500, "THB", "all", "18.50 THB"); // 18.5 → 18.50
  TestMonetaryValuetoText(850, "THB", "all", "0.85 THB");    // 0.85 → 0.85
  TestMonetaryValuetoText(85, "THB", "all", "0.08 THB");     // 0.085 → 0.08
  TestMonetaryValuetoText(4849, "THB", "all", "4.84 THB");   // 4.849 → 4.84
  TestMonetaryValuetoText(4851, "THB", "all", "4.85 THB");   // 4.851 → 4.85
  TestMonetaryValuetoText(4855, "THB", "all", "4.85 THB");   // 4.855 → 4.85
  TestMonetaryValuetoText(4859, "THB", "all", "4.85 THB");   // 4.859 → 4.85
  TestMonetaryValuetoText(2450, "THB", "all", "2.45 THB");   // 2.45
  TestMonetaryValuetoText(1250, "THB", "all", "1.25 THB");   // 1.25
  TestMonetaryValuetoText(6150, "THB", "all", "6.15 THB");   // 6.15
  TestMonetaryValuetoText(7350, "THB", "all", "7.35 THB");   // 7.35
  TestMonetaryValuetoText(9950, "THB", "all", "9.95 THB");   // 9.95
  TestMonetaryValuetoText(1050, "THB", "all", "1.05 THB");   // 1.05
  TestMonetaryValuetoText(1950, "THB", "all", "1.95 THB");   // 1.95
  TestMonetaryValuetoText(5050, "THB", "all", "5.05 THB");   // 5.05
  TestMonetaryValuetoText(1, "THB", "all", "0.00 THB");      // 0.001 → 0.00
  TestMonetaryValuetoText(5, "THB", "all", "0.00 THB");      // 0.005 → 0.00
  TestMonetaryValuetoText(9, "THB", "all", "0.00 THB");      // 0.009 → 0.00
  TestMonetaryValuetoText(10, "THB", "all", "0.01 THB");     // 0.01 → 0.01
  TestMonetaryValuetoText(0.1, "THB", "all", "0.00 THB");  // 0.0001
  TestMonetaryValuetoText(999999999, "THB", "all", "999,999.99 THB");
  TestMonetaryValuetoText(1000000000, "THB", "all", "1,000,000.00 THB");
});
...
describe('GPS', () => {
  ...
  function TestSetGPS(shippingAddress: ShippingAddress) {
    test("Set GPS", async () => {
      ...
      expect(result.testStatus).toEqual(200);
    });
  }
