<template>
    ...
    <div v-else>
        <MuiPage>
            <MuiHeader title="แจ้งยกเลิกการพักงาน" />
            <BizShareManaForm @submit="onSubmit">
                ...
                <MuiCard>
                    <div>
                        ...
                        <BizShareText text="กลับมาเป็นพนักงานตามปกติ" color="blue" alignment="center" :is-bold="true" />
                    </div>
                </MuiCard>
...
getData("get-announce-employee-unsuspended").then(async () => {
...
async function onSubmit() {
    await postData({}, "post-announce-employee-unsuspended");
}
</script>
