  ...
  <div v-else>
    <MuiPage class="bg-white">
      ...
      <MuiCard class="text-center bg-gray-100">
        <BizSharePartyHero src="i-lucide-chart-pie" title="เพิ่มวงเงิน" />
        <BizShareText :text="displayAmount(data.amount)" class="text-3xl" color="blue" />
      </MuiCard>
...
// getData('get-ca-allowance-addfunds').then(async () => {
