<template>
    ...
    <div v-else>
        <MuiPage>
            <MuiHeader title="แจ้งแต่งตั้งให้คุณเป็นโอเปอเรเตอร์" />
            <BizShareManaForm @submit="onSubmit">
                ...
                <MuiCard>
                    <div>
                        ...
                        <BizShareText text="คุณได้เป็นโอเปอเรเตอร์แล้ว" color="blue" alignment="center"
                            :is-bold="true" />
                    </div>
                </MuiCard>
...
import { ActionButton, getManaContext, ConsentButtonsBand } from "@manaapp/ui";
...
getData("get-announce-operator-assigned").then(async () => {
...
async function onSubmit() {
    await postData({}, "post-announce-operator-assigned");
}
</script>
