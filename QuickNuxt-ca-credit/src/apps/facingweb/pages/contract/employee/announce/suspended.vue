<template>
    ...
    <div v-else>
        <MuiPage>
            <MuiHeader title="แจ้งพักงานคุณชั่วคราว" />
            <BizShareManaForm @submit="onSubmit">
                ...
                <MuiCard>
                    <div>
                        ...
                        <BizShareText text="พักงานชั่วคราว" color="red" alignment="center" :is-bold="true" />
                    </div>
                </MuiCard>
                <div class="pt-8">
...
getData("get-announce-employee-suspended").then(async () => {
...
async function onSubmit() {
    await postData({}, "post-announce-employee-suspended");
}
</script>
